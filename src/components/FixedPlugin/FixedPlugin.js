...
class FixedPlugin extends Component {
  ...
  render() {
    return (
      <div className="fixed-plugin" style={{justifyContent:"center",alignContent:"center",alignItems:"center"}}>
        <div className={this.state.classes}>
          ...
          <ul className="dropdown-menu show">
            ...
            ><Button style={{marginTop:"20px",position:"relative",right:0,bottom:0}}>Get our services</Button></a>
          </ul>
        </div>
      </div>
    );
